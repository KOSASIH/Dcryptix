...
public class CacheConfiguration {
        ...
        if (this.registration == null) { // if registry is not defined, use native discovery
            ...
            return () ->
                GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-Dcryptix-cluster")
                    .jmx()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream
                .of(
                    com.kosasih.dcryptix.repository.UserRepository.USERS_BY_LOGIN_CACHE,
                    com.kosasih.dcryptix.repository.UserRepository.USERS_BY_EMAIL_CACHE
                )
                .forEach(cacheName ->
                    manager.defineConfiguration(
                        cacheName,
